...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2019 at 10:51 AM
...
--
-- Dumping data for table `tb_infotainment_fehlendelehrer`
--

INSERT INTO `tb_infotainment_fehlendelehrer` (`u_id`, `woche`) VALUES
(8048, 201946);
...
--
-- Dumping data for table `tb_infotainment_supplieren`
--

INSERT INTO `tb_infotainment_supplieren` (`u_id`, `woche`, `supplierer`, `beschreibung`) VALUES
(8048, 201946, 'KAE', ''),
(8053, 201946, 'KAE', ''),
(8095, 201946, '---', ''),
(8105, 201946, 'HÖM', '');
...
--
ALTER TABLE `tb_infotainment_unterricht`
  MODIFY `u_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8236;
